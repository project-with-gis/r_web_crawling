...
#     # print(total_review)
#     # total_review = total_review[700000:750000]
#
...
#
#     # csv 파일로 저장
#     # save_csv(total_review, 'naver_total(700000~750000).csv')
#     return total_review
...
# import pandas as pd
# review_data = pd.read_csv('data/naver_total_reviews_1107.csv')
# total_review = remove_nan(review_data, ['review', 'score'])
# total_review[0:1]

# 연습
# review_data = main('data/naver_preprocessed_reviews.csv')
# import pandas as pd
# review_data = pd.read_csv('data/naver_preprocessed_reviews.csv')
# review_data = review_data.astype({'preprocessed_review': 'str'})
# index_re = review_data[review_data['preprocessed_review'] == 'nan'].index.tolist()
# total_review = review_data.loc[index_re]
